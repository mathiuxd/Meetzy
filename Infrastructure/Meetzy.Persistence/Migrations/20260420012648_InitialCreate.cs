        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserReceivesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friendships_Users_UserReceivesId",
                        column: x => x.UserReceivesId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_Friendships_Users_UserSendId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommunityMembers_Communities_CommunityId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventAttendees_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityMembers_CommunityId1",
                table: "CommunityMembers",
                column: "CommunityId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventAttendees_UserId1",
                table: "EventAttendees",
                column: "UserId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friendships_UserReceivesId",
                table: "Friendships",
                column: "UserReceivesId");
